...
# Connexion
	...
	$_Lang_Con_Well = "Bienvenue sur High Media Serveur ";
	$_Lang_Con_Pseu = "Pseudo";
	$_Lang_Con_Pass = "Mot de passe";
	...
	#Reglementation
		...
		$_Lang_Con_Regl = "<div style='text-align: center; align-items: center;'>
		...
		$_Lang_Con_Pres = "<div style='text-align: center; align-items: center;'>
